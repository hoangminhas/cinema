...
@section('content')
    <div class="container mt-3">
        <div class="row mb-3">
            <div class="col-3">
                <h2 style="text-align: center">Create Foods</h2>
            </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required
                            ...
                            class="form-control" id="formGroupExampleInput" class="form-control" placeholder="Tên">
                    </div>
                    <div class="col">
                        <label for="exampleInputEmail1">Price</label>
                        <input type="text" name="price" value="{{ old('price') }}" required
                            oninvalid="this.setCustomValidity('Vui Long Nhap')" oninput="this.setCustomValidity('')"
                            class="form-control" id="formGroupExampleInput" class="form-control" placeholder="Giá">
                    </div>
                </div>
                <div class="mt-3">
                ...
                <div class="row mt-2">
                    <div class="col-4"> <button type="submit"
                            class="btn btn-success round btn-min-width mr-1 mb-1">Create Food</button></div>
